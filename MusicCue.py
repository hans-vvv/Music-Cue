...
import openpyxl
from utils import xlref, custom_layout_sheet, read_excel_tab
...
class MusicCue:
    ...
    def read_db_sheet(self):
        ...
        """
        fields = [('Episode name', 'episode_name'), ('Event', 'event'), ('Clip name', 'clip_name'),
    ...
    def read_source_sheet(self):
        ...
        """
        fields = [('SESSION NAME', 'episode_name'), ('EVENT', 'event'), ('CLIP NAME', 'raw_clip_name'),
    ...
    def create_episode_tabs(self):
        ...
        cache = self.get_artist_title_from_clip_name_cache()
