...
class MusicCueGui(ttk.Frame):
    ...
    try:
        ...
        logging.error(f"An unexpected error occurred during __init__ of MusicCueGui: {e}", exc_info=True)
        Messagebox.ok('Error: An unexpected error occurred during __init__ of MusicCueGui', alert=True)
